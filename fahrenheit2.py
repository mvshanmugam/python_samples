...
def calc_print(c):
    try:
        ...
        if (cel_float % 1 > 0) and (cel_decimals > 1):
            ...
            print('Fahrenheit value of ',cel_float,'deg C is : ', \
        ...
        for index in range(0, 10, 1):
            if cel_float < 0:                      #when cel_float is a negative number
                temp = cel_int - index * 1 / 10
            else:                                  #when cel_float is not a negative number
                temp = cel_int + index * 1 / 10

            print('Fahrenheit value of ',temp,'deg C is : ',round(fahrenheit(temp),2),' F')
